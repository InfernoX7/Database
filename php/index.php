...
<body>
	...
	<form action ="viewMember.php" method="post">
		<input type = "submit" value = 'View Member Details' name = "viewMember"><br>
	</form>
	</td>
	<td>
	<h2>View All Members /w Trainer</h2>
	<form action ="viewMember.php" method="post">
		<input type = "submit" value = 'View Members & Trainers' name = "viewMember"><br>
	</form>
	</td>
	</tr>
	<tr>
	...
	<form action ="viewMember.php" method="post">
		<input type = "submit" value = 'View Members & Class' name = "viewMember"><br>
	</form>
	</td>
	<td>
